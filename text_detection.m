close all;
% Step 1
%I = rgb2gray(imread('tortoise.png'));
I = rgb2gray(imread('inpaint.jpeg'));
%I = rgb2gray(imread('text.png'));
fil = [0,1,0;...
    1,1,1;...
    0,1,0];
fil = fil/5;
...
imshow(E);
title('Edge Image');
% I_erode = imerode(I_new,[0,0,0;0,1,0;1,0,0]);
subplot(2,2,4);
imshow(I_new);
title('Output Image of detected text');
